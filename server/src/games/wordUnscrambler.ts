...
export class WordUnscramblerGame extends BaseGame {
  ...
  // Word database - could be expanded or loaded from external file
  private words = [
    'AMAZING', 'COMPUTER', 'ELEPHANT', 'RAINBOW', 'KITCHEN',
    'JOURNEY', 'MYSTERY', 'BALLOON', 'GUITAR', 'SCIENCE',
    'DRAGON', 'CASTLE', 'ROCKET', 'FOREST', 'OCEAN',
    'WIZARD', 'PLANET', 'GARDEN', 'BRIDGE', 'ISLAND',
    'TREASURE', 'DIAMOND', 'THUNDER', 'BUTTERFLY', 'MOUNTAIN',
    'CHOCOLATE', 'ADVENTURE', 'MAGICAL', 'SUNSHINE', 'CRYSTAL',
    'FESTIVAL', 'HARMONY', 'VICTORY', 'WARRIOR', 'PHOENIX',
    'CHAMPION', 'FREEDOM', 'COURAGE', 'DESTINY', 'LEGEND',
    'and',
'to',
'of',
'a',
...
Your guess:`;
  ...
  private attemptBasicUnscramble(scrambled: string): string {
    ...
    if (this.words.includes(reversed)) return reversed;
    
    // Try original order
    if (this.words.includes(scrambled)) return scrambled;
